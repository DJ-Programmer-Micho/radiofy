...
class RegisterLisLivewire extends Component
{
    use WithFileUploads;
    ...
    protected function rules()
    {
        return [
            ...
            'username'   => 'required|string|max:255|unique:listeners,username',
    ...
    public function register()
    {
        ...
        if ($this->avatar) {
            ...
            if ($extension === 'png') {
                ...
                $finalPath = 'listener-avatar/' . $finalFilename;
        ...
        // Create the associated ListenerProfile.
        ...
        // Log the user in.
        Auth::guard('listener')->login($listener);
    ...
    {
        return view('listener.auth.register.register-form', [
