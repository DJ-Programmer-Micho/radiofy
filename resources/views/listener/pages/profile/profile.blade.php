            ...
            <div class="card-body p-4">
              <div class="text-center">
                <div class="profile-user position-relative d-inline-block mx-auto mb-4">
                    <img src="{{ $avatar ? $avatar->temporaryUrl() : (isset($listener->listener_profile->avatar) ? asset('storage/' . $listener->listener_profile->avatar) : asset('assets/default-avatar.png')) }}" 
                    alt="{{ $listener->listener_profile->first_name ?? 'User' }} {{ $listener->listener_profile->last_name ?? '' }}" 
                ...
                <h5 class="fs-16 mb-1">{{ $listener->listener_profile->first_name ?? '' }} {{ $listener->listener_profile->last_name ?? '' }}</h5>
                <p class="text-muted mb-0">Listener</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body p-4">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="changePassword" role="tabpanel">
                  @livewire('listener.profile.change-password-livewire')
                </div>
