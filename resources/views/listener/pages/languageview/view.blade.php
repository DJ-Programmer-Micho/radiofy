<div class="page-content">
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-start align-items-center p-0">
            <div>
                <img src="{{ asset('storage/'.$selectedLanguage->image_sq) }}" class="rounded" width="75px" alt="">
            </div>
            <div>
                <h1 class="px-3">{{ $selectedLanguage->name }}</h1>
            </div>
        </div>
        <hr>
        ...
        <div class="d-flex justify-content-start align-items-center p-0">
            <div>
                <h1 class="">Language's You May be Intrested</h1>
            </div>
        </div>
        <hr>
        <div class="row">
        ...
        <div class="row">
            <div>
                <h1 class="">More Radio On This Language</h1>
            </div>
