    ...
    <div class="container-fluid">
        <div class="profile-foreground position-relative mx-n4 mt-n4">
            <div class="profile-wid-bg">
                <img src="{{ $radio->radio_configuration_profile->banner ? asset('storage/' . $radio->radio_configuration_profile->banner) : asset('assets/logo/mradiofy-banner.png') }}" alt="" class="profile-wid-img" />
            </div>
        </div>
        <div class="pt-4 profile-wrapper" >
            <div class="row g-4">
                <div class="col-auto">
                    <div class="avatar-lg">
                        <img src="{{ $radio->radio_configuration_profile->logo ? asset('storage/' . $radio->radio_configuration_profile->logo) : asset('assets/logo/mradiofy-logo.png') }}" alt="user-img" class="img-thumbnail" />
                    </div>
                </div>
                <!--end col-->
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1"> {{ $radio->radio_name }}</h3>
                        ...
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $radio->radio_configuration_profile->location }}</div>
                            {{-- <div><i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $radio->radio_configuration_profile->languages }}</div> --}}
                        </div>
                    </div>
                </div>
                <!--end col-->
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            <button type="button" class="btn btn-success" onclick="window.dispatchEvent(new CustomEvent('switch-radio', { detail: { radioId: {{ $radio->id }} } }));">Play <i class="fa-solid fa-play" style="font-size:12px"></i></button>
                                ...
                                <div class="col-xxl-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->facebook))
                                                <div>
                                                    <a href="{{ json_decode($radio->radio_configuration_profile->social_media)->facebook }}" class="avatar-xs d-block" target="_blank">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->instagram))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->instagram }}" class="avatar-xs d-block" target="_blank">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->tiktok))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->tiktok }}" class="avatar-xs d-block" target="_blank">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->snapchat))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->snapchat }}" class="avatar-xs d-block" target="_blank">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->twitter))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->twitter }}" class="avatar-xs d-block" target="_blank">
                                                        <span class="avatar-title rounded-circle fs-16 bg-dark">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->linkedin))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->linkedin }}" class="avatar-xs d-block" target="_blank">
                                            ...
                                            @endif
                                            @if(!empty(json_decode($radio->radio_configuration_profile->social_media)->youtube))
                                                <div>
                                                    <a href="{{json_decode($radio->radio_configuration_profile->social_media)->youtube }}" class="avatar-xs d-block" target="_blank">
                                    ...
                                    @php
                                        // For locales, assuming the Languages table has a "name" field.
                                        $localeIds = is_array($radio->radio_configuration_profile->radio_locale)
                                            ? $radio->radio_configuration_profile->radio_locale
                                            : json_decode($radio->radio_configuration_profile->radio_locale, true) ?? [];
                                        $locales = \App\Models\Language::whereIn('id', $localeIds)->pluck('name')->toArray();
                                    
                                        // For genres, load the Genre models along with their translation.
                                        $genreIds = is_array($radio->radio_configuration_profile->genres)
                                            ? $radio->radio_configuration_profile->genres
                                            : json_decode($radio->radio_configuration_profile->genres, true) ?? [];
                                        $genres = \App\Models\Genre::whereIn('id', $genreIds)
                                            ->with(['genreTranslation' => function($query) {
                                                // Optionally filter by locale, e.g.,
                                                // $query->where('locale', config('app.locale'));
                                            }])
                                            ->get()
                                            ->map(function($genre) {
                                                return $genre->genreTranslation ? $genre->genreTranslation->name : 'N/A';
                                            })->toArray();
                                    @endphp
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                <div class="col-xxl-9">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p>{{ $radio->radio_configuration_profile->description }}</p>
                                            <!--end row-->
                                        </div>
                                        <!--end card-body-->
                                    </div><!-- end card -->
                                    ...
                                    @foreach ($otherRadio as $oRadio)
                                            <div class="col-6 col-md-3 col-lg-2">
                                                <div class="card-poster radio-card-1">
                                                    <button type="button" class="btn btn-none p-0" onclick="window.dispatchEvent(new CustomEvent('switch-radio', { detail: { radioId: {{ $oRadio->id }} } }));">
                                                        <div class="player-icon" style="overflow: hidden;">
                                                            <img src="{{ $oRadio->radio_configuration_profile->logo ? asset('storage/' . $oRadio->radio_configuration_profile->logo) : asset('assets/logo/mradiofy-logo.png') }}"
                                                                class="img-fluid" 
                                                                alt="Logo">
                                                        </div>
                                                    </button>
                                                    <div class="d-flex justify-content-between">
                                                        <div>
                                                            <a href="{{ route('listener.radio',['radio' => $oRadio->id])}}" rel="noopener noreferrer">
                                                                <p class="m-0"><b>{{ $oRadio->radio_name }} {{ $oRadio->id }}</b></p>
                                                            </a>
                                                            </div>
                                                            <div>
