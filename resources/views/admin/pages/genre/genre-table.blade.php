<div class="page-content">
    @include('admin.pages.genre.genre-form')
    <div class="container-fluid">
        ...
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addGenreModal">
            <i class="fa-regular fa-plus me-2"></i>{{ __('Add Genre') }}
        </button>
                                ...
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="genre-{{ $data->id }}">
                                            ...
                                            <td class="align-middle text-center">
                                                {{ optional($data->GenreTranslation)->name ?? 'N/A' }}
                                            </td>
                                            <td class="align-middle text-center">
                                            ...
                                            <td class="align-middle  text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item" wire:click="editGenre({{ $data->id }})" data-bs-toggle="modal" data-bs-target="#updateGenreModal">
                                                                <i class="fa-regular fa-pen-to-square me-2"></i>{{ __('Edit') }}
                                                            </button>
                                                        </li>
                                                        <li class="dropdown-divider"></li>
                                                        <li>
                                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteGenreModal" wire:click="confirmDeleteGenre({{ $data->id }})">
