<div class="page-content">
    @include('admin.pages.plan.plan-form')
    <div class="container-fluid">
        ...
        <!-- Add Radio Button -->
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addPlanModal">
            <i class="fa-regular fa-plus me-2"></i>{{ __('Add Plan') }}
        </button>        
        <!-- Radio Table -->
        <div class="row">
            <div class="col-12">
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <button type="button" class="dropdown-item" wire:click="editPlan({{ $data->id }})" data-bs-toggle="modal" data-bs-target="#updatePlanModal">
                                                                <i class="fa-regular fa-pen-to-square me-2"></i>{{ __('Edit') }}
                                                            </button>
                                                        </li>
                                                        <li class="dropdown-divider"></li>
                                                        <li>
                                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deletePlanModal" wire:click="confirmDeletePlan({{ $data->id }})">
