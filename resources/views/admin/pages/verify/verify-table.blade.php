<div class="page-content">
    @include('admin.pages.verify.verify-form')
    <div class="container-fluid">
        <!-- Page Title -->
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('Verification Plans') }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('Dashboard') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('Verification Plans') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <!-- Add Button -->
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addVerificationModal">
            <i class="fa-regular fa-plus me-2"></i>{{ __('Add Verification Plan') }}
        </button>        
        <!-- Verification Table -->
        <div class="row">
            <div class="col-12">
                                ...
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">{{ __('Monthly Price') }}</th>
                                            <th class="text-center">{{ __('Yearly Price') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="verify-{{ $data->id }}">
                                            ...
                                            <td class="text-center">${{ number_format($data->sell_price_monthly, 2) }}</td>
                                            <td class="text-center">${{ number_format($data->sell_price_yearly, 2) }}</td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><button class="dropdown-item" wire:click="editVerification({{ $data->id }})" data-bs-toggle="modal" data-bs-target="#updateVerificationModal">
                                                            <i class="fa-regular fa-pen-to-square me-2"></i>{{ __('Edit') }}
                                                        </button></li>
                                                        <li class="dropdown-divider"></li>
                                                        <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteVerificationModal" wire:click="confirmDeleteVerification({{ $data->id }})">
