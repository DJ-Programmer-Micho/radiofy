<div class="page-content">
    @include('subscriber.pages.e-radio.radio-form')
    <div class="container-fluid">
        ...
        <!-- Add Radio Button -->
        <button data-bs-toggle="modal" data-bs-target="#addRadioModal" class="btn btn-primary mb-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="radio-{{ $data->id }}">
                                            <td class="align-middle text-center">
                                                    @if($data->external_radio_configuration_profile->logo)
                                                        <img src="{{ asset('storage/' . $data->external_radio_configuration_profile->logo) }}" class="img-fluid" width="50" height="50" alt="Logo">
                                                    @else
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end m-index">
                                                        <li>
                                                            <button type="button" class="dropdown-item" wire:click="editRadio({{ $data->id }})" data-bs-toggle="modal" data-bs-target="#updateRadioModal">
                                                                <i class="fa-regular fa-pen-to-square me-2"></i>{{ __('Edit Radio') }}
                                                            </button>
                                                        </li>
                                                        <li class="dropdown-divider"></li>
                                                        <li>
                                                            <a href="{{ route('subs-external-radio-manage', ['radio_id' => $data->id]) }}" class="dropdown-item">
                                                                <i class="fa-regular fa-credit-card me-2"></i>{{ __('Radio Management') }}
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <button type="button" class="dropdown-item" wire:click="confirmDeleteRadio({{ $data->id }})" data-bs-toggle="modal" data-bs-target="#deleteRadioModal">
